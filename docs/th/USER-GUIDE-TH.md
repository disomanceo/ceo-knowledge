...
หน้า Chat รองรับการอ่านข้อความของ Ceo ด้วยเสียงของอุปกรณ์ (Device TTS) บนเว็บ/PWA โดยออกแบบให้ใช้ได้กับ Android, iPhone/iPad และ Windows เมื่อ browser มี Web Speech / Speech Synthesis:

- **OFF** — ปิดเสียงทั้งหมด
- **MANUAL** — ค่าเริ่มต้น กด **ฟัง** ที่คำตอบของ Ceo เมื่อต้องการ
- **AUTO** — คำตอบใหม่ของ Ceo จะพูดอัตโนมัติ
- **SMART** — พูดอัตโนมัติแต่ย่อข้อความยาว/เทคนิคก่อนอ่าน เช่น code/log จะไม่ถูกอ่านยาวทั้งหน้าจอ
- **ทดสอบเสียง** — ใช้เปิด/ตรวจเสียงของอุปกรณ์ โดยเฉพาะ iPhone/iPad ที่ browser อาจต้องมีการแตะจากผู้ใช้ก่อนให้เล่นเสียงอัตโนมัติ
- **หยุด** — หยุดเสียงที่กำลังพูดทันที

การตั้งค่า Voice เก็บใน localStorage ของอุปกรณ์นั้น ไม่ถูกส่งไป Supabase และไม่ต้องมี API Key/TTS Cloud สำหรับ V1 หาก browser ไม่รองรับ ระบบจะแสดงสถานะว่าไม่รองรับและ Chat แบบข้อความยังทำงานตามปกติ
